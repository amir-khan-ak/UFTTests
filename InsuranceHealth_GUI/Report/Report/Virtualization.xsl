      ...
      <html>
        ...
        <body>
          <table border="0" cellpadding="3" cellspacing="0" width="100%">
            ...
            <tr>
              <td height="30">
                <p>
                  <span class="hl1name">
                    <xsl:copy-of select="$IDS_VIRTUALIZATION" />
                  </span>
                </p>
              </td>
            </tr>
          ...
          <p>
            <p>
              <span class="hl1name">
                <xsl:copy-of select="$IDS_VIRTUALIZED_SERVICES" />
              </span>
            </p>
                    ...
                    <tbody>
                      <tr bgcolor="EEEEEE">
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_PROJECT_NAME" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_SERVICE_NAME" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_MODE" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_DATA_MODEL" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_PERFORMANCE_MODEL" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_SIMULATION_SERVER" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_DATA_SIMULATION_ACCURACY" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_PERFORMANCE_SIMULATION_ACCURACY" />
                          </span>
                        </td>
                        <td valign="middle" align="center" class="tablehl">
                          <span class="tablehl">
                            <xsl:copy-of select="$IDS_DEPLOYED" />
                          </span>
                        </td>
                      </tr>
                      <tr>
